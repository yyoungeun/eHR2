...
import static com.ehr.service.UserService.MIN_LOGINCOUNT_FOR_SILVER;
import static com.ehr.service.UserService.MIN_RECCOMEND_FOR_GOLD;
...
public class UserServiceTest {
	...
	public void upgradeAllOrNothing() throws SQLException {
		UserService testUserService = new TestUserService(users.get(3).getU_id());
...
class TestUserServiceException extends RuntimeException{ //런타임 예외 unchecked exception 
	public TestUserServiceException() { //UserService - exception으로 - rollback함
		System.out.println("==============================");
